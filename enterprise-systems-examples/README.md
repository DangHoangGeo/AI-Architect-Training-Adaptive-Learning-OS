...
Ten real-world, enterprise-grade systems used as reference case studies for architecture practice. Each one models a system that exists in production at real companies, sized and constrained the way an enterprise architect would actually encounter it — not a toy CRUD app.
