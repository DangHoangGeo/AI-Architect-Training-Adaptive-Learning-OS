# Design — Multi-region Resilient System

## Problem statement
Design multi-region resilient system on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
