# Design — Secure Network Foundation

## Problem statement
Design secure network foundation on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
