# Design — AI Document Processing System

## Problem statement
Design ai document processing system on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
