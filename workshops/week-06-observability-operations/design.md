# Design — Production Observability Platform

## Problem statement
Design production observability platform on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
