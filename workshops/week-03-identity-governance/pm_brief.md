# PM Brief — Identity-enabled Enterprise App

## Customer problem
The organization needs identity-enabled enterprise app capabilities without creating an over-engineered platform that small teams cannot operate.
