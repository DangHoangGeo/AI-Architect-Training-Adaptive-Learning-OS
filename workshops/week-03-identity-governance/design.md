# Design — Identity-enabled Enterprise App

## Problem statement
Design identity-enabled enterprise app on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
