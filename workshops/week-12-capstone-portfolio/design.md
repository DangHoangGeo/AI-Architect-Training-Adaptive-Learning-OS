# Design — Capstone AI Governance Platform

## Problem statement
Design capstone ai governance platform on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
