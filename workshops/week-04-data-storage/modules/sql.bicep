// Week 04 complexity tier: service tier parameterization, backup retention, audit log wiring
...
@description('SQL database service tier. Basic for dev, S1-S3 for standard prod, P1+ for high-throughput.')
param serviceObjectiveName string = 'Basic'

@description('Short-term backup retention in days. Max 35. Prod minimum 14 for most compliance frameworks.')
@minValue(1)
@maxValue(35)
...
// Audit logs to Log Analytics — only deployed when workspace ID is provided
