# PM Brief — Data-backed Application Platform

## Customer problem
The organization needs data-backed application platform capabilities without creating an over-engineered platform that small teams cannot operate.
