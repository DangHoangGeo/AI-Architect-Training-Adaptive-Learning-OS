# Design — Data-backed Application Platform

## Problem statement
Design data-backed application platform on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
