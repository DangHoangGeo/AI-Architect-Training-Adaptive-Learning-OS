# PM Brief — Scalable E-commerce Platform

## Customer problem
The organization needs scalable e-commerce platform capabilities without creating an over-engineered platform that small teams cannot operate.
