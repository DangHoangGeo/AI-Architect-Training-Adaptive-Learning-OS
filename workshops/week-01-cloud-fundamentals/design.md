# Design — Basic Web App Architecture

## Problem statement
Design basic web app architecture on Azure with secure defaults, measurable operations, cost awareness, and an evolution path.
